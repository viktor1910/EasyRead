...
export const authorAPI = {
  ...
  create: (data) => apiRequest('/authors', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id, data) => apiRequest(`/authors/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
  delete: (id) => apiRequest(`/authors/${id}`, {
    method: 'DELETE',
  }),
};
...
export const reviewAPI = {
  ...
  create: (bookId, data) => apiRequest(`/books/${bookId}/reviews`, {
    method: 'POST',
    body: JSON.stringify(data),
  }),
...
export const cartAPI = {
  get: () => apiRequest('/cart'),
  add: (bookId, quantity = 1) => apiRequest('/cart/add', {
    method: 'POST',
    body: JSON.stringify({ book_id: bookId, quantity }),
  }),
  update: (itemId, quantity) => apiRequest(`/cart/update/${itemId}`, {
    method: 'PUT',
...
export const orderAPI = {
  ...
  checkout: (data) => apiRequest('/orders/checkout', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id, data) => apiRequest(`/orders/${id}/update`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
};
...
export const authAPI = {
  ...
  register: (name, email, password, passwordConfirmation) => apiRequest('/register', {
    method: 'POST',
    body: JSON.stringify({ 
      name, 
      email, 
