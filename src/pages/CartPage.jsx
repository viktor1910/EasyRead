        ...
        <CardContent>
          <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
            <Typography variant="h6">
              Sản phẩm ({cart.items.length} loại sản phẩm, {cart.items_count} sản phẩm)
            </Typography>
            <Button
              variant="outlined"
              color="error"
          ...
          {cart.items.map((item) => (
            <Box key={item.id}>
              ...
              >
                ...
                {/* Điều chỉnh số lượng */}
                <Box sx={{ flex: '0 0 140px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 1 }}>
                ...
                {/* Nút xóa */}
                <Box sx={{ flex: '0 0 60px', display: 'flex', justifyContent: 'center' }}>
                  <IconButton
                    color="error"
